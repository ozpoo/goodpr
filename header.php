					...
					<?php else: ?>
						<div class="back">
							<a href="<?php echo site_url( '/', 'http' ); ?>">
								<svg version="1.1"
									 xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:a="http://ns.adobe.com/AdobeSVGViewerExtensions/3.0/"
									 x="0px" y="0px" width="43.5px" height="43.5px" viewBox="0 0 43.5 43.5" style="enable-background:new 0 0 43.5 43.5;"
									 xml:space="preserve">
								<line class="st0" x1="0.5" y1="0.5" x2="43" y2="43"/>
								<line class="st0" x1="0.5" y1="43" x2="43" y2="0.5"/>
								</svg>
							</a>
						</div>
					<?php endif; ?>
